...
<template>
  <div class="p-4 pb-20">
    ...
    <!-- نموذج الاستلام -->
    <div v-if="showReceive" class="bg-gray-900 rounded-xl p-4 mb-4">
      <div class="flex items-center justify-between mb-3">
        <h3 class="font-semibold flex items-center gap-2">
          <ArrowDownLeftIcon size="18" class="text-green-400" />
          استلام SYT
        </h3>
        <button @click="showReceive = false" class="text-gray-400">✕</button>
      </div>
    ...
    <!-- نموذج الإرسال -->
    <div v-if="showSend" class="bg-gray-900 rounded-xl p-4 mb-4">
      <div class="flex items-center justify-between mb-3">
        <h3 class="font-semibold flex items-center gap-2">
          <ArrowUpRightIcon size="18" class="text-red-400" />
          إرسال SYT
        </h3>
        <button @click="showSend = false" class="text-gray-400">✕</button>
      </div>
